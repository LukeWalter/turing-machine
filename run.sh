...
javac -d bin -cp bin src/project/tm/InvalidInputException.java
javac -d bin -cp bin src/project/tm/NondeterminismException.java
javac -d bin -cp bin src/project/tm/Tape.java
